...
namespace SoftwareMonkeys.SiteStarter.Business
{
	...
	public class KeywordFactory
    {
		...
		{
            return (Keyword[])Collection<Entities.Keyword>.ConvertAll(DataStore.GetEntities<Entities.Keyword>());
		}
        ...
        static public Entities.Keyword GetKeyword(Guid keywordID)
		{
            ...
            return (Entities.Keyword)DataAccess.Data.GetEntity<Keyword>("ID", keywordID);
		}
        ...
        {
            return (Entities.Keyword)DataAccess.Data.GetEntity<Keyword>("Name", name);
        }
		#endregion
