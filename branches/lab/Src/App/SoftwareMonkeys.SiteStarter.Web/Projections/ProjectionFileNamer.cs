	...
	public class ProjectionFileNamer
	{
			...
			get {
				if (projectionsDirectoryPath == null || projectionsDirectoryPath == String.Empty)
				{
					if (StateAccess.IsInitialized)
						projectionsDirectoryPath = StateAccess.State.PhysicalApplicationPath + Path.DirectorySeparatorChar + "Projections";
				}
		...
		public virtual string ProjectionsInfoDirectoryPath
		{
			get {
				...
				{
					if (StateAccess.IsInitialized)
						projectionsInfoDirectoryPath = StateAccess.State.PhysicalApplicationPath + Path.DirectorySeparatorChar + "App_Data" + Path.DirectorySeparatorChar + "Projections";
				}
