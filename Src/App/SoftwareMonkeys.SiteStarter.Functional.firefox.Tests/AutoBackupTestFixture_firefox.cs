...
{
	[TestFixture]
	public class AutoBackupTestFixture_firefox : SoftwareMonkeys.SiteStarter.Functional.Tests.BaseFunctionalTestFixture
	{
		...
		public void Test_AutoBackup()
		{
			...
			Thread.Sleep(10000);
			selenium.Open("Admin/tests/LogContains.aspx?Query=${AutoBackup}");
