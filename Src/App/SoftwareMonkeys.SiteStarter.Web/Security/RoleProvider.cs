...
namespace SoftwareMonkeys.SiteStarter.Web.Security
{
    ...
    public class RoleProvider : System.Web.Security.RoleProvider
    {
      ...
      //  private string connectionString;
        ...
        public override void AddUsersToRoles(string[] usernames, string[] rolenames)
        {
            ...
            foreach (string username in usernames)
            {
                foreach (string rolename in rolenames)
                {
                    ...
                    UserRole role = UserRoleFactory.GetUserRoleByName(rolename);
        ...
        {
            UserRole[] roles = UserRoleFactory.GetUserRoles();
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            UserRole[] roles = UserRoleFactory.GetUserRoles(user.RoleIDs);
        ...
        public override string[] GetUsersInRole(string rolename)
        {
            ...
            User[] users = UserFactory.GetUsers(role.UserIDs);
        ...
        public override string[] FindUsersInRole(string rolename, string usernameToMatch)
        {
            ...
            User[] allUsers = UserFactory.GetUsers(role.UserIDs);
