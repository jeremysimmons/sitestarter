...
namespace SoftwareMonkeys.SiteStarter.Web
{
	...
	public class UrlCreator
	{
		...
		{
			string url = CreateUrl(action, type);
			...
			//    && type != "Project" // If the type is project then there's no need for the project ID in the link
			//   )
			//{
			//	url = url + separator + "CurrentProjectID=" + ProjectsState.ProjectID.ToString();
			//}
		...
		{
			string url = CreateUrl(action, type, propertyName, dataKey);
